...
public class TaskCompletionEvent 
  ...
  static public enum Status {
     ...
     SUCCEEDED,
     /**
      * Used to Override a previously successful event status. Example:  Map attempt
      * runs and a SUCCEEDED event is sent. Later a task is
      * retroactively failed due to excessive fetch failure during shuffle phase.
      * When the retroactive attempt failure occurs, an OBSOLETE event is sent for
      * the map attempt indicating the prior event is no longer valid.
      */
     OBSOLETE,
     /**
